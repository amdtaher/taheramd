        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-12 grid-flow-row flex-col-reverse justify-items-center items-center relative px-5 sm:px-0">
            ...
            <div className="col-span-12 md:col-span-7 lg:max-w-[40rem] flex flex-col gap-6 text-center md:text-left relative capitalize">
              ...
              {/* CTA */}
              <div className="mt-5">
                <a href="#projects" className="inline-flex items-center justify-center px-8 py-3 text-dark bg-light rounded-full font-semibold transition duration-300 linear border-2 border-dark shadow-lg hover:text-light hover:bg-dark hover:scale-105">
                  View My Work
                </a>
              </div>
            </div>
